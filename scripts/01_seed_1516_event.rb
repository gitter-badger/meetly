...
e = Event.create!(name: 'Poczatek', 
            start_date: Date.new(2015,12,29), end_date: Date.new(2015, 12,31), owner: u, capacity: 700)
puts "Event #{e.name} created!"

pp = PricingPeriod.create!(name: 'Pierwszy termin', event: e, start_date: Date.new(2015, 10, 1), end_date: Date.new(2015, 11, 11))
...
ep = EventPrice.create!(pricing_period: pp, role: r, event: e, price: 99)
...
dp1 = DayPrice.create!(price: 0, pricing_period: pp, role: r, day: d1)
