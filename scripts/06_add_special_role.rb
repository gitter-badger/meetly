e = Event.find_by(name: 'Poczatek 15/16')
puts "Found event #{e.name}"
o = Role.create!(name: 'Specjalna', event_id: e.id)
...
dpo31 = DayPrice.create!(price: 59.0, pricing_period: pp1, role: o, day: d3)
...
dpo32 = DayPrice.create!(price: 59.0, pricing_period: pp2, role: o, day: d3)

puts "Special set up finished"
