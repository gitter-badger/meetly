...
class RolesTest < ActionDispatch::IntegrationTest
  test 'role_price_table should return proper hash' do
    get '/role_price_table?name=Uczestnik'
  ...
  test 'role_price_table should not return with bad role name' do
    get '/role_price_table?name=Pastor'
